        ...
        <div class="max-w-5xl mx-auto">
          <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              <div class="max-w-md">
                <span class="text-lg font-bold">Register Account</span>
                <h2 class="mt-8 mb-12 text-5xl font-bold">Start creating a new template by selecting UI components</h2>
                <p class="text-lg">
            ...
            <div class="w-full lg:w-1/2 px-4">
              <div class="px-6 lg:px-20 py-12 lg:py-24 bg-second/80 rounded-lg">
                <form action="#">
                  <h3 class="mb-10 text-2xl text-white font-bold">Register Account</h3>
                  <div class="flex items-center pl-6 mb-3 bg-white rounded-full">
                    ...
                    <input class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="email" placeholder="user@mail.com" />
                  </div>
                  <div class="flex items-center pl-6 mb-3 bg-white rounded-full">
                    <span class="inline-block pr-3 py-2 border-r border-gray-50">
                  ...
                  <div class="inline-flex mb-10">
                    ...
                    <p class="-mt-2 text-sm text-gray-500">By singning up, you agree to our <a class="text-white" href="#">Terms, Data Policy</a>and <a class="text-white" href="#">Cookies.</a></p>
                  </div>
                  <button class="mb-5 py-4 w-full bg-yellow-500 hover:bg-yellow-400 text-white font-bold rounded-full transition duration-200">Sign up</button>
                  <nuxt-link to="/login"><button class="py-4 w-full bg-yellow-500 hover:bg-yellow-400 text-white font-bold rounded-full transition duration-200">Login</button></nuxt-link>
                </form>
              </div>
            </div>
          </div>
