        ...
        <div class="max-w-5xl mx-auto">
          <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              <div class="max-w-md">
                <span class="text-lg font-bold">Login Account</span>
            ...
            <div class="w-full lg:w-1/2 px-4">
              <div class="px-6 lg:px-20 py-12 lg:py-24 bg-second/80 rounded-lg">
                <form action="#">
                  <h3 class="mb-10 text-2xl text-white font-bold">Login Account</h3>
                  ...
                  <div class="flex items-center pl-6 mb-14 bg-white rounded-full">
                    <span class="inline-block pr-3 py-2 border-r border-gray-50">
                  ...
                  <button class="mb-5 py-4 w-full bg-yellow-500 hover:bg-yellow-400 text-white font-bold rounded-full transition duration-200">Login</button>
                  <nuxt-link to="/signup"><button class="py-4 w-full bg-yellow-500 hover:bg-yellow-400 text-white font-bold rounded-full transition duration-200">Sign up</button></nuxt-link>
                </form>
              </div>
            </div>
          </div>
